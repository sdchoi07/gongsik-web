		...
		if (data.totalCnt === 0) {
			...
			var row = `
				<div class="d-flex justify-content-end mt-2" >
				    <button onclick='openModal()' class="btn btn-primary border-0 fw-bold" id="addBtn" style="margin-right:15px;background-color: #000000; font-family: 'Noto Sans KR', sans-serif;">배송지 추가</button>
					</div>
				<div class="col-xl-12 mt-4">
					    <div class="bg-white shadow d-flex justify-content-center" style="height: 300px;  width: 100%;">
					        <div class="d-flex align-items-center">
					            <span>배송지 내역이 없습니다.</span>
					        </div>
					    </div>
					</div>
					`
